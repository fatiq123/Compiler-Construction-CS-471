...
public:
    ...
    // void translateInstruction(const string &instr) {
    //     istringstream iss(instr);
    //     vector<string> tokens((istream_iterator<string>(iss)), istream_iterator<string>());

    //     if (tokens.size() == 3 && tokens[1] == "=") {
    //         // Handle assignment
    //         assemblyCode.push_back("MOV " + tokens[0] + ", " + tokens[2]);
    //     } else if (tokens.size() == 5 && tokens[1] == "=") {
    //         // Handle arithmetic operations
    //         if (tokens[3] == "+") {
    //             assemblyCode.push_back("MOV AX, " + tokens[2]); // Load operand1
    //             assemblyCode.push_back("ADD AX, " + tokens[4]); // Add operand2
    //             assemblyCode.push_back("MOV " + tokens[0] + ", AX"); // Store result
    //         } else if (tokens[3] == "-") {
    //             assemblyCode.push_back("MOV AX, " + tokens[2]);
    //             assemblyCode.push_back("SUB AX, " + tokens[4]);
    //             assemblyCode.push_back("MOV " + tokens[0] + ", AX");
    //         } else if (tokens[3] == "*") {
    //             assemblyCode.push_back("MOV AX, " + tokens[2]);
    //             assemblyCode.push_back("MUL " + tokens[4]);
    //             assemblyCode.push_back("MOV " + tokens[0] + ", AX");
    //         } else if (tokens[3] == "/") {
    //             assemblyCode.push_back("MOV AX, " + tokens[2]);
    //             assemblyCode.push_back("DIV " + tokens[4]);
    //             assemblyCode.push_back("MOV " + tokens[0] + ", AX");
    //         }
    //     } else if (tokens.size() == 4 && tokens[0] == "if") {
    //         // Handle conditional jumps
    //         assemblyCode.push_back("CMP " + tokens[1] + ", 0");
    //         assemblyCode.push_back("JE " + tokens[3]); // Jump if zero
    //     } else if (tokens.size() == 2 && tokens[0] == "goto") {
    //         // Handle unconditional jumps
    //         assemblyCode.push_back("JMP " + tokens[1]);
    //     } else if (tokens.size() == 2 && tokens[0].back() == ':') {
    //         // Handle labels
    //         assemblyCode.push_back(tokens[0]);
    //     } else if (tokens.size() == 2 && tokens[0] == "return") {
    //         // Handle return statement
    //         assemblyCode.push_back("MOV AX, " + tokens[1]);
    ...
    void translateInstruction(const string &instr)
    {
        ...
        else if (tokens.size() == 5 && tokens[1] == "=")
        {
            ...
            {
                assemblyCode.push_back("MOV AX, " + tokens[2]);
                assemblyCode.push_back("ADD AX, " + tokens[4]);
                assemblyCode.push_back("MOV " + tokens[0] + ", AX");
            }
            else if (tokens[3] == "*")
            {
        ...
        else if (tokens[0] == "if" && tokens.size() == 4)
        {
            // Correct handling of condition
            assemblyCode.push_back("CMP " + tokens[1] + ", 0");
            assemblyCode.push_back("JNE " + tokens[3]); // Jump if not zero
        }
        else if (tokens[0] == "goto")
        {
            assemblyCode.push_back("JMP " + tokens[1]); // Unconditional jump
        }
        else if (tokens[0].back() == ':')
        {
            assemblyCode.push_back(tokens[0]); // Labels
        }
    }
...
private:
    ...
    */
    ...
    void parseIfStatement()
    {
        expect(T_IF);
        expect(T_LPAREN);
        string cond = parseExpression(); // Parse condition
        expect(T_RPAREN);

        icg.addInstruction("if " + cond + " goto L1"); // Directly use the condition
